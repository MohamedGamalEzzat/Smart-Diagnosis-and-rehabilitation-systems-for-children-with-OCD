    ...
    <div id="wrapper">
        ...
        <div id="myElement">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{url('controlimegupr')}}">
                    <i class="fas fa-play-circle"></i>
                        <span>رفع الصوره الشخصيه</span></a>
                </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">رفع صور الشخصيه </h1>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <form  action="{{ route('contrimgupr') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <label for="photo">صورة الشخصيه:</label>
                                <input type="file" id="image" name="image_userpro" accept="photo/*" required>
