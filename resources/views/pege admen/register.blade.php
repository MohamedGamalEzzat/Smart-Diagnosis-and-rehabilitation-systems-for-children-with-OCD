            ...
            <div class="card-body p-0">
                ...
                <div class="text-center">
                    ...
                    <div class="col-lg-13">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">انشاء حساب ادمن </h1>
                            </div>
                            <form method="POST" action="{{route('rgesa')}}">
                                @csrf
                                ...
                                <input type="submit" name='rgesa' value="إنشاء حساب" class="btn btn-primary btn-user btn-block">
                            </form>
