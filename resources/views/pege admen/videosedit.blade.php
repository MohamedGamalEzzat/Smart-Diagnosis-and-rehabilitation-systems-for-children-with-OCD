            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">رفع الفيديو </h1>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('videoupdate', $video->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="cvideo_name" id="video_name" value="{{ $video->cvideo_name }}" class="form-control">
                            </div>

                            <div class="form-group">
                                <label for="video_file">رفع فيديو :</label>
                                <input type="file" id="video" name="cvideo_file"  accept="video/*" >

                            </div>
                            <label for="video_duration">مدة الفيديو (بالساعات:الدقائق:الثواني):</label>
                            <input type="text" id="video_duration" name="cvideo_time"  value="{{ $video->cvideo_time }}"pattern="[0-9]+:[0-5][0-9]:[0-5][0-9]" title="أدخل الساعات والدقائق والثواني بصيغة صحيحة، مثال: 5:30:00" required>

                            <div class="form-group">
                                <label for="description">الوصف:</label>
                                <textarea name="cdescription" id="description" class="form-control">{{ $video->cdescription }}</textarea>
                            </div>

                            <!-- إضافة المزيد من حقول النموذج حسب الحاجة -->
                            <button type="submit" class="btn btn-primary">حفظ التغييرات</button>
                        </form>
                        <div class="form-group">
                            <label for="video_file">الفيديو:</label>
