                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <form  action="{{ route('uploadvideo') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <label for="video_name">اسم فيديو:</label>
                                <input type="text" id="name" name="cvideo_name" required>

                                <label for="video_file">رفع فيديو :</label>
                                <input type="file" id="video" name="cvideo_file" accept="video/*" required>

                                <label for="video_duration">مدة الفيديو (بالساعات:الدقائق:الثواني):</label>
                                <input type="text" id="video_duration" name="cvideo_time" placeholder="مثال: 5:30:00" pattern="[0-9]+:[0-5][0-9]:[0-5][0-9]" title="أدخل الساعات والدقائق والثواني بصيغة صحيحة، مثال: 5:30:00" required>

                        

                                <label for="description">وصف الفيديو:</label>
                                <textarea id="description" name="cdescription" rows="4" required></textarea>
