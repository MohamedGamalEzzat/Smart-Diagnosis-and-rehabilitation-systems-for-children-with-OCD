        ...
        <div class="content d-flex mainHeight">
            <div class="form">
                <div class="container mainPadding containerPage">
                    <h3 class="mainH3"> تسجيل الدخول دكتور </h3>
                    ...
                    <form method="POST" action="{{ route('doctorlogin') }}">
                        ...
                        <input type="text" placeholder="رقم الهاتف أو الإيميل" class="d-block w-75" name='d_email'>
                        <div class="form-group">
                            <label for="password">كلمة المرور:</label>
                            <input type="password" class="form-control" id="password" name="d_password" required>
                        </div>
                        <div class="loginSubmit">
                            <input type="submit" name='doctorlogin' value="تسجيل الدخول " class="d-block sendBtn text-center w-75">
                            {{-- @error('email')
                      <span>{{ $message }}</span>
                     @enderror --}}
                        </div>
                    ...
                    <div class="switch">
                        ...
                        <div class="SwitchLogin position-relative">
                            ...
                            <a href="{{url('SignUp')}}" class="d-inline">إنشاء حساب</a>
                        </div>
                    </div>
                </div>
            </div>
