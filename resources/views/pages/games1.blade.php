                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="container-fluid d-flex justify-content-between">
                            ...
                            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active " href="{{url('games1')}}">الألعاب</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="image">
                                    <img src="../style pages/image/Ellipse 79.png" alt="" class="dis-none">
                                </div>
                            </div>
                        </div>
                    </nav>
...
<div class="loading">
    <div class="image">
        <img src="{{asset('../style pages/image/path64.png')}}" alt="" class="dis-none">
    </div>
    <div class="container">
        <div class="content d-flex justify-content-center">
            <div class="text ">
                ...
                <div class="main">
                    <h3>استعد للمرح والتشويق مع عالم مليء بالألوان والمغامرات في فيديوهاتنا الممتعة !
                    </h3>
                </div>

                <div class="imageQuery">
                    <img src="{{asset('../style pages/image/girl.png')}}" alt="">
                </div>
                <div class="links">
                    <a href="{{url('games2')}}">تصفح الآن</a>
                    <a href="{{url('games1')}}">مشاهدة الالعاب</a>
                </div>
            </div>
            <div class="box dis-none">
                <div class="photo">
                    <img src="{{asset('../style pages/image/girl.png')}}" alt="" class="imgLoading">
                </div>
            </div>
        </div>
    </div>
...
<!-- start about  -->
    <div class="about">
        <div class="image">
            <img src="{{asset('../style pages/image/path64.png')}}" alt="" class="">
            <img src="{{asset('../style pages/image/ice.png')}}" alt="" class="">
            <img src="{{asset('../style pages/image/Star.png')}}" alt="">
            <img src="{{asset('../style pages/image/Vector 100.png')}}" alt="" class="">
        </div>
        <div class="container">
          <div class="row">
            <div class="col-lg-5 align-self-center  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
              <div class="left-image">
                <img src="{{asset('../style pages/image/game photo.png')}}" alt="">
              </div>
            </div>
            <div class="col-lg-7 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
              <div class="about-heading">
                <p>ما هي ألعابنا ؟</p>
                <span>تم تصميم مجموعتنا من الألعاب المخصصة للأطفال لإثارة خيالهم وتعزيز الإبداع وتوفير ساعات لا نهاية لها من الترفيه.</span>
                <h5>بدءًا من المغامرات المثيرة في عوالم ملونة وحتى الألغاز المثيرة للعقل والتحديات التعليمية، تقدم ألعابنا مجموعة متنوعة من التجارب التي تلبي الاهتمامات وأساليب التعلم المختلفة. يمكن للأطفال الشروع في مهام مثيرة، وحل الألغاز، وإطلاق العنان لمواهبهم الفنية، وحتى تعلم مهارات جديدة على طول الطريق.</h5>
              </div>
            </div>
          </div>
        </div>
...
<div class="games">
    <div class="img2">
        ...
        <img src="{{asset('../style pages/image/lightmode.png')}}" alt="" class="sun">
    </div>
