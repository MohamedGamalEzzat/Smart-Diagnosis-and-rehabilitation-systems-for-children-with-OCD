...
<body>
                ...
                <div class="row">
                    <div class="col-lg-5 align-self-center  fadeInLeft">
                        <div class="left-image">
                            <img src="{{asset('../style pages/image/about us photo.png')}}" class="h">
                        </div>
                    </div>
    ...
    <!-- End about -->
        <!-- End AboutHome -->
        <!-- Start secApp -->
        <!-- <div class="secApp position-relative">
            <div class="container">
                <ul class="d-grid">
                    <li><i class="fa-solid fa-check"></i><p class="d-inline">يوجد تطبيق هاتف</p></li>
                    <li><i class="fa-solid fa-check"></i><p class="d-inline">يوجد تطبيق هاتف</p></li>
                    <li><i class="fa-solid fa-check"></i><p class="d-inline">يوجد تطبيق هاتف</p></li>
                    <li><i class="fa-solid fa-check"></i><p class="d-inline">يوجد تطبيق هاتف</p></li>
                </ul>
                <div class="insertImage position-absolute">
                    <img src="../style pages/image/Umbrella.png" alt="">
                </div>
            </div>
        </div> -->
        <!-- End secApp -->
        ...
        <div class="playGame position-relative">
                    <div class="container">
                        ...
                        <div class="content d-grid">
                            <div class="box">
                                <div class="image">
                                    <img src="{{asset('../style pages/image/Rectangle 3 (1).png')}}" alt="">
                                </div>
                                <h4>اسم اللعبه</h4>
                            ...
                            <div class="box">
                                <div class="image">
                                    <img src="{{asset('../style pages/image/Rectangle 3 (2).png')}}" alt="">
                                </div>
                                <h4>اسم اللعبه</h4>
                                <p>لعبة الوسواس القهري هي تجربة تفاعلية وجذابة مصممة لمساعدة الأطفال على فهم وإدارة اضطراب الوسواس القهري بطريقة ممتعة وداعمة.</p>
                                <div class="links">
                            ...
                            <div class="box">
                                <div class="image">
                                    <img src="{{asset('../style pages/image/Rectangle 3.png')}}" alt="">
                                </div>
                                <h4>اسم اللعبه</h4>
                                <p>لعبة الوسواس القهري هي تجربة تفاعلية وجذابة مصممة لمساعدة الأطفال على فهم وإدارة اضطراب الوسواس القهري بطريقة ممتعة وداعمة.</p>
                                <div class="links">
    ...
    <div class="footer">
        <div class="container d-flex content">
            ...
            <div class="box">
                ...
                <ul>
                    <li><a href="home78">الرئيسية</a></li>
                    <li><a href="openingPage">ماذا عنا </a></li>
                    <li><a href="learn">التعلم</a></li>
                    <li><a href="games1">الألعاب</a></li>
